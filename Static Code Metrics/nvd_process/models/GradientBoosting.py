...
if __name__ == '__main__':
    ...
    param_grid = {
        'n_estimators': np.linspace(210, 220, 2).astype(int),
        'subsample': [0.8, 1.0],
        'max_depth': [None] + list(np.linspace(6, 8, 3).astype(int)),
        'max_features': [8, 10],
        'max_leaf_nodes': [None] + list(np.linspace(64, 128, 2).astype(int)),
