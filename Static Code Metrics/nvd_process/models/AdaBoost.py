...
if __name__ == '__main__':
    ...
    param_grid = {
        'n_estimators': np.linspace(110, 130, 3).astype(int),
        'learning_rate': np.arange(0.8, 1, 0.1)
    }
    estimator = AdaBoostClassifier(DecisionTreeClassifier(max_features = 0.7, max_depth = 12,
                                    min_samples_split = 4), algorithm = 'SAMME.R')
