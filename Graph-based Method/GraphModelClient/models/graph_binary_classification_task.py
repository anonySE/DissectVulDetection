...
from GraphModelClient.data import GraphDataset
from GraphModelClient.models import GraphTaskModel
from GraphModelClient.layers import WeightedSumGraphRepresentation, NodesToGraphRepresentationInput
...
class GraphBinaryClassificationTask(GraphTaskModel):
    ...
    def compute_task_output_new(
        ...
        # concat
        if per_graph_results_1.shape.as_list()[0] != per_graph_results_2.shape.as_list()[0]:
            per_graph_results_2 = tf.pad(per_graph_results_2, [[0, per_graph_results_1.shape.as_list()[0]-per_graph_results_2.shape.as_list()[0]], [0, 0]])
