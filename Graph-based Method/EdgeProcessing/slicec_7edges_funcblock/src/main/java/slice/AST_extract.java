...
public class AST_extract {
    ...
    public void AST_NvdGoodBad(String sourceFilePath, String storeFilePath, int batchnum_lastrun, int batchsize) {
        //store file path
        if (!new File(storeFilePath).exists()) {
            new File(storeFilePath).mkdirs();
        }
        ...
        if (fs != null) {
            ...
            System.out.println("vul_funcs: " + count_bad + ",    non_vul_funcs: " + count_good);
        }
    }
}
